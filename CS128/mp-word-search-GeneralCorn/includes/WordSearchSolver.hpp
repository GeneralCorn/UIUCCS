...
public:
  ...
  WordLocation Vertical(const std::string& word, size_t row, size_t col);
  WordLocation Horizontal(const std::string& word, size_t row, size_t col);
  WordLocation RightDiagonal(const std::string& word, size_t row, size_t col);
  WordLocation LeftDiagonal(const std::string& word, size_t row, size_t col);
